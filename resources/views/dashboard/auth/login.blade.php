                                        ...
                                        <div class="main-signup-header">
                                            ...
                                            <div class="container select-hide">
                                                {{-- Select To login --}}
                                                        ...
                                                        <select name="somename" class="form-control select2-no-search" id="selectForm"
                                                ...
                                                <div class="font-size-18 mt-5 text-center">
                                                    ...
                                                    <p class="text-muted text-center">الدخول بواسطة الأدمن</p>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" name="email" placeholder="أدخل بريدك الإلكتروني" type="text">
                                                            <x-input-error :messages="$errors->get('email')" class="mt-2" />

                                                        </div>
                                                        <div class="form-group">
                                                            <label>كلمة المرور</label>
                                                            <input class="form-control" name="password" placeholder="ادخل رقمك السري" type="password">
                                                            <x-input-error :messages="$errors->get('password')" class="mt-2" />

                                                        </div><button class="btn btn-main-primary btn-block">تسجيل الدخول</button>
                                                        <div class="row row-xs">
                                                            <div class="col-sm-6">
                                                                <button class="btn btn-block"><i class="fab fa-facebook-f"></i> اشترك عبر حساب فيسبوك</button>
                                                            </div>
                                                            <div class="col-sm-6 mg-t-10 mg-sm-t-0">
                                                                <button class="btn btn-info btn-block"><i class="fab fa-twitter"></i> الاشتراك عبر تويتر</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                            <div class="main-signin-footer mt-5 mb-3">
                                                @if (Route::has('password.request'))
                                                    <a href="{{ route('password.request') }}"><i class="mdi mdi-lock"></i>
                                                        نسيت كلمة المرور ؟
                                                    </a>
                                                @endif
                                                <p>ليس لديك حساب؟ <a href="page-signup.html">إنشاء حساب جديد</a></p>
                                            </div>
                                        </div>
