    ...
    <div class="row row-sm">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive" id="vacationTable">
                            ...
                            <tbody>
                                ...
                                <tr id="vacationRow{{ $vacation->id }}">
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        <div class="{{ $vacation->status == '1' ? 'success' : 'danger' }} ml-1"></div>
                                    </td>
                                    <td>{{ $vacation->notes }}</td>
                                    <td>
                                        <!-- Edit -->
                                        <a class="btn btn-outline-info btn-sm" href="{{ route('dashboard.vacations.edit', $vacation->id) }}">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <!-- Print -->
                                        @if ($vacation->status == '1')
                                        <a class="btn btn-outline-primary btn-sm" href="{{ route('dashboard.vacation-print', $vacation->id) }}">
                                            <i class="fas fa-print"></i>
                                        </a>
                                        @endif
                                        <!-- Delete -->
                                        <a class="modal-effect btn btn-outline-danger btn-sm" data-effect="effect-scale" data-toggle="modal" href="#delete{{ $vacation->id }}">
                                            <i class="fas fa-trash-alt"></i>
                                        </a>
                                        @include('dashboard.vacations.delete', ['vacation' => $vacation])
                                    </td>
                                </tr>
                                 @endforeach
                            </tbody>
                    ...
                    if (data.success) {
                        ...
                        setTimeout(() => {
                            successMessage.fadeOut('slow', function() {
                                successMessage.addClass('d-none').show(); // Ensure it is hidden and reset for next time
                            });
