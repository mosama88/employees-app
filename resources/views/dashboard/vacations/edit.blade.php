        ...
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
            <div class="card  box-shadow-0 ">
                ...
                <div class="card-body pt-0">
                    ...
                    @endif
                    <form action="{{route('dashboard.vacations.update', 'test')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                ...
                                <select name="employee_id" class="form-control select2">
                                    ...
                                    @foreach($employees as $employee)
                                        <option value="{{$employee->id}}"{{$employee->id == $vacation->employee_id ? 'selected':"" }}>{{$employee->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group col-6">
                                ...
                                <select name="type" class="form-control select2-no-search" id="selectFormgrade"
                                    ...
                                    <option value="emergency"{{ $vacation->type === 'emergency' ? 'selected' : '' }}>عارضه</option>
                        ...
                        <div class="row">
                            <div class="form-group col-6">
                                ...
                                <input class="form-control fc-datepicker" id="exampleInputtsart" value="{{$vacation->start}}" type="date" name="start" placeholder="YYYY-DD-MM">
                            </div>
                            <div class="form-group col-6">
                                <label for="exampleInputto">أنتهاء الأجازه</label>
                                <input class="form-control fc-datepicker" id="exampleInputto" value="{{$vacation->to}}" type="date" name="to" placeholder="YYYY-DD-MM">
                            </div>
                        </div>
